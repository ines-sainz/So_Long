...
int	ft_load_images(t_game *game)
{
	...
	game->wall = mlx_xpm_file_to_image(game->mlx, "sprite/1.xpm", &x, &y);
	game->player = mlx_xpm_file_to_image(game->mlx, "sprite/P.xpm", &x, &y);
	game->floor = mlx_xpm_file_to_image(game->mlx, "sprite/0.xpm", &x, &y);
	game->collectibles = mlx_xpm_file_to_image(game->mlx,
			"sprite/C.xpm", &x, &y);
	game->exit = mlx_xpm_file_to_image(game->mlx, "sprite/E.xpm", &x, &y);
	game->enemy1 = mlx_xpm_file_to_image(game->mlx, "sprite/X1.xpm", &x, &y);
	game->enemy2 = mlx_xpm_file_to_image(game->mlx, "sprite/X2.xpm", &x, &y);
	game->enemy3 = mlx_xpm_file_to_image(game->mlx, "sprite/X3.xpm", &x, &y);
	game->enemy4 = mlx_xpm_file_to_image(game->mlx, "sprite/X4.xpm", &x, &y);
